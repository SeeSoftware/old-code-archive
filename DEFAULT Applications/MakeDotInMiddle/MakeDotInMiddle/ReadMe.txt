========================================================================
    KONSOLENANWENDUNG: MakeDotInMiddle-Projektübersicht
========================================================================

Diese MakeDotInMiddle-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MakeDotInMiddle-Anwendung besteht.


MakeDotInMiddle.vcxproj
...
MakeDotInMiddle.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MakeDotInMiddle.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
