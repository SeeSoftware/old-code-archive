...
namespace GESFML {
	...
	public:
		...
		void createSprite(long long unsigned id, float x, float y, int xs, int ys);
		void createSprite(long long unsigned id, float x, float y, int xs, int ys, sf::Texture &texture);
		...
		void setPosition(long long unsigned id, float x, float y);
		void setTexture(long long unsigned id, sf::Texture &texture);
		void setScale(long long unsigned id, float x, float y);
