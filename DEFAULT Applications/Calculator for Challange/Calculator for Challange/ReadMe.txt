========================================================================
    KONSOLENANWENDUNG: Calculator for Challange-Projektübersicht
========================================================================

Diese Calculator for Challange-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Calculator for Challange-Anwendung besteht.


Calculator for Challange.vcxproj
...
Calculator for Challange.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Calculator for Challange.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
