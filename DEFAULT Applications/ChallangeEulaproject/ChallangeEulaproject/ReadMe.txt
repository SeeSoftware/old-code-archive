========================================================================
    KONSOLENANWENDUNG: ChallangeEulaproject-Projektübersicht
========================================================================

Diese ChallangeEulaproject-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ChallangeEulaproject-Anwendung besteht.


ChallangeEulaproject.vcxproj
...
ChallangeEulaproject.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ChallangeEulaproject.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
