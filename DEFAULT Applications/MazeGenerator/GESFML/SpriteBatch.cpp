...
namespace GESFML {
	...
	void SpriteBatch::createSprite(long long unsigned id, float x, float y, int xs, int ys) {
		sf::Sprite sprite;
	...
	void SpriteBatch::createSprite(long long unsigned id, float x, float y, int xs, int ys, sf::Texture &texture) {
	...
	void SpriteBatch::setPosition(long long unsigned id, float x, float y) {
	...
	void SpriteBatch::setScale(long long unsigned id, float x, float y) {
