...
namespace GESFML
{
	...
	public:
		...
		void drawAllText(Window &window);
		...
		void drawAllOcclusion(Window &window, sf::IntRect rect);
		...
		bool testPointSprite(float x, float y);
		long long testPointSpriteId(float x, float y);
		std::vector<long long> testPointSpriteIdAll(float x, float y);
		bool testPointSpriteId(long long id, float x, float y);
		//---------------------------------------------------------------
		void createText(long long id, float x, float y, float wScale, float hScale, int characterSize, sf::Font &font, std::string text, sf::Color color, float rotation = 0);
		void setText(long long id, std::string text);
		void deleteText(long long id);
		...
		void setTextCharacterSize(long long id, int size);
		...
		int getTextCharacterSize(long long id);
		...
		void setPhysicSpriteDraw(long long id,bool draw);
		bool getPhysicSpriteDraw(long long id);
		...
		std::vector<long long> testPointIdPhyiscSpriteAll(float x, float y);
		...
		void setIdsToIgnoreWhileDrawingSprites(std::vector<long long> table);
		void setIdsToIgnoreWhileDrawingPhysicSprites(std::vector<long long> table);

		std::unordered_map<long long, sf::Sprite>& getSpriteShadowBatch();
		std::unordered_map<long long, sf::Sprite>& getSpriteBatch();
		std::unordered_map<long long, sf::Sprite>& getPhysicSpriteShadowBatch();
		std::unordered_map<long long, sf::Sprite>& getPhysicSpriteBatch();
		...
		std::vector<long long> &getIdsToIgnoreWhileDrawingSpritesArray();
		std::vector<long long> &getIdsToIgnoreWhileDrawingPhysicSpritesArray();
		b2World *getWorld();

	private:
		std::vector<long long> _idsToIgnoreWhileDrawingSprite;
		std::vector<long long> _idsToIgnoreWhileDrawingPhysicSprite;
		std::unordered_map<long long, sf::Sprite> _shadowBatch;
		std::unordered_map<long long, sf::Sprite> _physicShadowBatch;
		std::unordered_map<long long, sf::Vector2f> _shadowOffsets;
		std::unordered_map<long long, sf::Vector2f> _physicShadowOffsets;
		std::unordered_map<long long, sf::Sprite> _spriteBatch;
		std::unordered_map<long long, sf::Sprite> _physicSpriteBatch;
		...
		std::unordered_map<long long, bool> _doDrawPhysicsSprite;
		std::unordered_map<long long, int> _drawOrderText;
		std::unordered_map<long long, sf::Text> _textBatch;
