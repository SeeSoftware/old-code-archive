========================================================================
    KONSOLENANWENDUNG: Team Test Project-Projektübersicht
========================================================================

Diese Team Test Project-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Team Test Project-Anwendung besteht.


Team Test Project.vcxproj
...
Team Test Project.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Team Test Project.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
