========================================================================
    KONSOLENANWENDUNG: ackermann function-Projektübersicht
========================================================================

Diese ackermann function-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ackermann function-Anwendung besteht.


ackermann function.vcxproj
...
ackermann function.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ackermann function.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
